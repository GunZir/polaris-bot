...
#include "messages/msg/detail/robot_motor_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const messages::msg::RobotMotorSpeed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages::msg::RobotMotorSpeed & ros_message)
{
  // Member: right_motor_speed
  cdr >> ros_message.right_motor_speed;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_messages
max_serialized_size_RobotMotorSpeed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages::msg::RobotMotorSpeed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages::msg::RobotMotorSpeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages::msg::RobotMotorSpeed *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotMotorSpeed__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const messages::msg::RobotMotorSpeed *>(
...
static size_t _RobotMotorSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotMotorSpeed(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotMotorSpeed__callbacks = {
  "messages::msg",
  "RobotMotorSpeed",
...
static rosidl_message_type_support_t _RobotMotorSpeed__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotMotorSpeed__callbacks,
...
{
  return &messages::msg::typesupport_fastrtps_cpp::_RobotMotorSpeed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, RobotMotorSpeed)() {
  return &messages::msg::typesupport_fastrtps_cpp::_RobotMotorSpeed__handle;
}
