...
static rosidl_typesupport_introspection_c__MessageMember my_custom_message__msg__MyCustomMessage__rosidl_typesupport_introspection_c__MyCustomMessage_message_member_array[2] = {
  {
    ...
    offsetof(my_custom_message__msg__MyCustomMessage, test_a),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_message__msg__MyCustomMessage, test_b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
