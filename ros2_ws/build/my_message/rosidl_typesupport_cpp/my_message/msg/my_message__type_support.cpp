...
static const _MyMessage_type_support_symbol_names_t _MyMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_message, msg, MyMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_message, msg, MyMessage)),
  }
};
...
{
  return &::my_message::msg::rosidl_typesupport_cpp::MyMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_message, msg, MyMessage)() {
  return get_message_type_support_handle<my_message::msg::MyMessage>();
}
