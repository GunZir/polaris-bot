...
class Metaclass_MyMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_message')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'my_message.msg.MyMessage')
            logger.debug(
...
class MyMessage(metaclass=Metaclass_MyMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.ice = kwargs.get('ice', int())
        self.prad = kwargs.get('prad', int())
    ...
    def ice(self, value):
        if __debug__:
            assert \
                ...
                "The 'ice' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'ice' field must be an integer in [-2147483648, 2147483647]"
        self._ice = value
    ...
    def prad(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'prad' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'prad' field must be an integer in [-2147483648, 2147483647]"
        self._prad = value
